 ...
 *
 */
@WebServlet("/api/reportes/admin/ingresosEmpresa")
public class ReportesIngresosEmpresaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            List<ReporteIngresosEmpresaDTO> data
                    = service.generarReporteIngresosEmpresa();
            ...
            InputStream reporte = getClass()
                    .getClassLoader()
                    .getResourceAsStream(
                            "Reportes/Jasper/admin/ReportesIngresosEmpresa.jasper"
                    );
